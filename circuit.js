class Circuit {
  ...
  //creates the environment with road and roadside objects
  //____________
  create() {
    //clear arrays
    this.segments = [];
  ...
  //Creates a road
  //since this is straight, it can only create one section
  //_________
  ...
  createSegment() {
    ...
    this.segments.push({
      ...
      //alternate color the groups of segments dark and light
